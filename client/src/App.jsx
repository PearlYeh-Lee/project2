...
function App() {
  ...
  function newChickenAdder(inputName, inputAge, inputBreed){
    ...
    const newChickenDictionary = {name: inputName, age: inputAge, breed: inputBreed};
    currentChickenList.push(newChickenDictionary)
    setChickenList(currentChickenList)
    axios.post('http://localhost:5000/api/postChicken',  {name: inputName, age: inputAge, breed: inputBreed}).then((response)=>{
